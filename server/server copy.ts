...
let allNotes = [
  ...
  {
    id: '2',
    content: '🛫 Flight details: flying out of Manchester --> landing in Florence.',
    categoryId: '1',
  },
  {
    id: '3',
  ...
  {
    id: '4',
    content: "🍨 Delicious gelato: 'Gelateria dei Neri', Via dei Neri, 9/11R, 50122 Firenze",
    categoryId: '1',
  },
  {
    id: '5',
    content: "🚲 Bike rental places: 'Florent - Bike rental', Via della Mosca, 10r, 50122 Firenze",
    categoryId: '1',
  },
  {
    id: '6',
    content: '📅 Train schedules on last day: 13:50 Platform 1, Florence Station --> Train to Rome',
    categoryId: '1',
  },
...
(async function () {
  ...
  restRouter.get('/notes', (req, res, next) => {
    ...
    const categorisedNotes = categoryId ? allNotes.filter((note) => note.categoryId === categoryId) : allNotes;
    const notes = categorisedNotes.slice(offset, offset + limit).map((note) => ({
      id: note.id,
